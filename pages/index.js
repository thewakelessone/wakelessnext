       ...
       <div className={styles.container}>
          <article className={styles.article}>
            ...
            <div className={styles.text}>
              <p><b>Capitalism is dying.</b> And the era of all-powerful nation states, mega corporations
              that control the weather, and central banks that print their own money is almost,
              mercifully, over.</p>
            </div>
            <div className={styles.text}>
              <p>The fat rich balding white men that have been hoarding the
              wealth of the world and limiting the flow of information since the dawn of time
              will not go down easy. So there are ugly years to come. But the war is as good as
              won as there is no power on heaven or earth that is a match for the collective
              intelligence of the human race.</p>
            </div>
            <div className={styles.text}>
              <p>So order that case of Dom and polish your
              oyster tray but don't send out the invitations just yet. There is still work to be done.
              And If you are as excited and impatient as we are join the cause and foment
            ...
            <div className={styles.text}>
              <p><b>Wakeless is a conceptional framework designed to prepare us for the impending
              transformation.</b> A set of ideologies, methodologies, architectural schemes,
